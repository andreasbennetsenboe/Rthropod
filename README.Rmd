...
For people that are not used to working with R or .csv files one can use the 'pointscheme.xlsx' to record observations and then save as a .csv file and just name it the integer that represents the group. When all schemes are collected at the end of the day you can start importing. Do this as a list of teams:
...
You then feed this list to the function calculate_standings(). If you want to change anything in the point system, the function has a number of parameters for this, see the help file ?calculate_standings for details.
